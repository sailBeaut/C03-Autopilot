...
if __name__ == "__main__":
    ...
    printeigenvalues = False  # Set to True to print eigenvalues

    accuracy1, accuracy2 = model2(run, array, resolution, flip, divfactor, k_g, k1_numvalue, k2_numvalue, c1_numvalue, c2_numvalue, a_velo, extragraphs, showmainplots, printeigenvalues)