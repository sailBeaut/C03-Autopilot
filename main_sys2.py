...
k2_numvalue_elev = 21.8
c1_numvalue_elev = 50
c2_numvalue_elev = 4.75
k_g_elev = 0.22
a_velo_elev = 2.85e-7
flip_elev = 1
...
#Run the model
if ground == True:
    acc_ground_DOF1, acc_ground_DOF2 = model2(0, array, resolution, clutch_ail, flip_ail, divfactor_ail, k_g_ail, k1_numvalue_ail, k2_numvalue_ail, c1_numvalue_ail, c2_numvalue_ail, a_velo_ail, extragraphs, showmainplots, printeigenvalues)
for run in range(1, 14):
    if run == 2:
        ...
        if run in (1, 3, 8, 9, 10, 11) and aileron == True:
            acc_run_DOF1, acc_run_DOF2 = model2(run, array, resolution, clutch_ail, flip_ail, divfactor_ail, k_g_elev, k1_numvalue_ail, k2_numvalue_ail, c1_numvalue_ail, c2_numvalue_ail, a_velo_ail, extragraphs, showmainplots, printeigenvalues)
            ...
            acc_run_DOF1, acc_run_DOF2 = model2(run, array, resolution, clutch_elev, flip_elev, divfactor_elev, k_g_elev, k1_numvalue_elev, k2_numvalue_elev, c1_numvalue_elev, c2_numvalue_elev, a_velo_elev, extragraphs, showmainplots, printeigenvalues)
