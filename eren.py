...
for i in (4,5,6,7,12,13):
    ...
    IservoAil = IservoAil-IservoAil[0]

    # Tuning Parameters 
    c1 = 1.5  # Damper constant 3.5
    k1 = 7   # Spring constant 52

    # Set Parameters
    kg = -0.22 # Gain 
    Ie = 0.01 # Moment of inertia  0.045
    ...
    plt.plot(time_steps, 0.02*IservoAil, color="y", label="Current")
