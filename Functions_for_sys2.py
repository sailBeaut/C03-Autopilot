...
def accuracy_plot(accuracy_dof1_array, accuracy_dof2_array):
    ...
    plt.axhline(y=avg_acc1_wo11, color='g', linestyle=':', label=f"Average DOF1 (no run11): {avg_acc1_wo11:.2f}%")
    plt.axhline(y=avg_acc2_wo11, color='o', linestyle=':', label=f"Average DOF2 (no run11): {avg_acc2_wo11:.2f}%")
    plt.axhline(y=avg_acc1_wo9n11, color='p', linestyle='-.', label=f"Average DOF1 (no run9 and run11): {avg_acc1_wo9n11:.2f}%")
    plt.axhline(y=avg_acc2_wo9n11, color='y', linestyle='-.', label=f"Average DOF2 (no run9 and run11): {avg_acc2_wo9n11:.2f}%")
    plt.xlabel("Run")
    plt.ylabel("Accuracy (%)")
