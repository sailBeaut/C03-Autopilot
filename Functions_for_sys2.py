...
def accuracy_plot(accuracy_dof1_array, accuracy_dof2_array):
    ...
    plt.axhline(y=avg_acc1_wo11, color='r', linestyle=':', label=f"Average DOF1 (no run11): {avg_acc1_no11:.2f}%")
    plt.axhline(y=avg_acc2_wo11, color='b', linestyle=':', label=f"Average DOF2 (no run11): {avg_acc2_no11:.2f}%")
    plt.xlabel("Run")
    plt.ylabel("Accuracy (%)")
