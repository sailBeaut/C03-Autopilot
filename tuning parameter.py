...
def calculate_average_accuracy_dof2(accuracy_DOF1):
    return np.mean(accuracy_DOF1)
...
while best_accuracy < 82:
    ...
    average_accuracy_dof1 = calculate_average_accuracy_dof2(accuracy_DOF1)

    # Check if the current parameters give better accuracy for DOF 2
    if average_accuracy_dof1 > best_accuracy:
        best_accuracy = average_accuracy_dof1
